...
return (new CustomEvent(event_name,(function (){var obj27834 = ({"detail":data});
return obj27834;
})()));
} else {
...
var f = (function (){var pred__27841 = cljs.core._EQ_;
var expr__27842 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27841.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27842))){
return (function (p1__27835_SHARP_){
return console.warn(p1__27835_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27841.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27842))){
return (function (p1__27836_SHARP_){
return console.debug(p1__27836_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27841.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27842))){
return (function (p1__27837_SHARP_){
return console.error(p1__27837_SHARP_);
});
} else {
return (function (p1__27838_SHARP_){
return console.log(p1__27838_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27845){
var map__27846 = p__27845;
var map__27846__$1 = cljs.core.__destructure_map.call(null,map__27846);
var opts = map__27846__$1;
var eval_fn = cljs.core.get.call(null,map__27846__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27847_SHARP_){
return new_def.callback(p1__27847_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27848){
var vec__27849 = p__27848;
var ky = cljs.core.nth.call(null,vec__27849,(0),null);
...
}catch (e27854){if((e27854 instanceof Error)){
var e = e27854;
return not_found;
} else {
throw e27854;
...
//# sourceMappingURL=utils.js.map?rel=1745332062840
