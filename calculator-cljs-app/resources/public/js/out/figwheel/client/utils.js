...
return (new CustomEvent(event_name,(function (){var obj27887 = ({"detail":data});
return obj27887;
})()));
} else {
...
var f = (function (){var pred__27894 = cljs.core._EQ_;
var expr__27895 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27894.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27895))){
return (function (p1__27888_SHARP_){
return console.warn(p1__27888_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27894.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27895))){
return (function (p1__27889_SHARP_){
return console.debug(p1__27889_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27894.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27895))){
return (function (p1__27890_SHARP_){
return console.error(p1__27890_SHARP_);
});
} else {
return (function (p1__27891_SHARP_){
return console.log(p1__27891_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27898){
var map__27899 = p__27898;
var map__27899__$1 = cljs.core.__destructure_map.call(null,map__27899);
var opts = map__27899__$1;
var eval_fn = cljs.core.get.call(null,map__27899__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27900_SHARP_){
return new_def.callback(p1__27900_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27901){
var vec__27902 = p__27901;
var ky = cljs.core.nth.call(null,vec__27902,(0),null);
var v = cljs.core.nth.call(null,vec__27902,(1),null);
...
}catch (e27907){if((e27907 instanceof Error)){
var e = e27907;
return not_found;
} else {
throw e27907;
...
//# sourceMappingURL=utils.js.map?rel=1744477358919
